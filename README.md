...
This same logic (adding /apidoc_template to the root folder) can be applied to any Loopback 2.0 working app.
...
```
$ git clone git@github.com:amenadiel/loopback-example-app.git
